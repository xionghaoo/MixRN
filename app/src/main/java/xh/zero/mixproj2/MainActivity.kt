...
class MainActivity : AppCompatActivity() {
    ...
    fun start(v: View) {
        startActivity(Intent(this@MainActivity, MyRNActivity::class.java))
    }
...
//        request.setDescription("desc")
        val destFileName = getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS)?.toString() + File.separator + "test.zip"
